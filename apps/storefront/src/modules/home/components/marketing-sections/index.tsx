...
const SectionHeading = ({
  ...
  <div className="mx-auto max-w-[900px] text-center">
    <p className="text-xs font-semibold uppercase text-[#3b6c82]">
      {eyebrow}
    </p>
    <h2 className="mt-4 text-[clamp(2rem,4vw,4rem)] font-black uppercase leading-[0.95] text-[#0b2450]">
      {title}
    </h2>
...
const ListCard = ({
  ...
  <article className="border border-slate-200 bg-white p-8 shadow-[0_24px_50px_-40px_rgba(15,23,42,0.45)]">
    <h3 className="text-[1.35rem] font-black uppercase text-[#0b2450]">
      {title}
    </h3>
    ...
    <>
      <section className="relative overflow-hidden bg-white py-20 text-slate-950">
        <div className="pointer-events-none absolute inset-0">
          ...
          <div className="absolute -left-16 top-0 h-56 w-56 border border-[#f1ddd2]" />
          <div className="absolute right-0 top-16 h-64 w-64 translate-x-1/2 border border-[#d8e7ef]" />
        </div>
      ...
      <section className="relative overflow-hidden bg-[#eef5f8] py-20 text-slate-950">
        ...
        <div className="content-container relative">
          <div className="mx-auto max-w-[1160px] border border-[#d8e4eb] bg-[linear-gradient(180deg,#f4f8fb_0%,#f4f8fb_100%)] p-4 shadow-[0_36px_80px_-58px_rgba(8,36,77,0.65)] md:p-6">
            <div className="grid gap-6 lg:grid-cols-[minmax(280px,0.82fr)_minmax(0,1.18fr)]">
              <div className="relative overflow-hidden bg-[#08244d] p-8 text-white md:p-10">
                <div className="pointer-events-none absolute inset-0">
                  <div className="absolute -left-10 top-10 h-40 w-40 bg-[#1f4f83]/40 blur-3xl" />
                  <div className="absolute right-0 top-0 h-56 w-56 bg-[#0ea5b7]/18 blur-3xl" />
                  <div className="absolute bottom-0 left-1/3 h-40 w-40 bg-[#f3b46b]/16 blur-3xl" />
                </div>

                <div className="relative">
                  <p className="text-xs font-semibold uppercase text-[#9de8ff]">
                    Why Choose Sassntial
                  </p>
                  <h2 className="mt-6 max-w-[11ch] text-[clamp(2rem,3.7vw,3.6rem)] font-black uppercase leading-[0.9] text-white">
                  ...
                  <div className="mt-10 border border-white/10 bg-white/8 p-6 backdrop-blur-sm">
                    <p className="text-sm font-semibold uppercase text-[#9de8ff]">
                      Operating Advantage
                    </p>
                    <p className="mt-4 text-[clamp(2rem,3vw,2.75rem)] font-black text-white">
                      One connected model
                    </p>
              ...
              <div className="grid gap-5 md:grid-cols-2">
                {whyChooseItems.map((item, index) => (
                  <article
                    key={item.title}
                    className={`group relative overflow-hidden border border-[#d7e2ea] bg-white p-6 shadow-[0_25px_55px_-42px_rgba(15,23,42,0.55)] transition-transform duration-300 hover:-translate-y-1 md:p-7 ${
                  ...
                  >
                    <div className="pointer-events-none absolute inset-0 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                      ...
                      <div className="absolute -right-10 -top-10 h-32 w-32 bg-[#eff8fc]" />
                    </div>

                    <div className="relative">
                      <div className="flex items-center justify-between gap-4">
                        <div className="text-[clamp(2rem,3vw,3rem)] font-black leading-none text-[#0b2450]">
                          {item.stat}
                        </div>
                        <div className="flex h-12 w-12 items-center justify-center bg-[#e9f5fb] text-lg font-black text-[#d97a4d] shadow-inner">
                          +
                        </div>
                      </div>

                      <h3 className="mt-7 max-w-[13ch] text-[1rem] font-black uppercase leading-[1.05] text-[#0b2450] md:text-[1.05rem]">
                        {item.title}
                      </h3>
        ...
        <div className="content-container relative">
          ...
          <div className="mx-auto mt-14 grid max-w-[1160px] gap-6 lg:grid-cols-2 xl:grid-cols-3">
            {growthSteps.map((step, index) => (
              <article
                key={step.title}
                className="border border-slate-200 bg-white p-8 shadow-[0_24px_50px_-40px_rgba(15,23,42,0.45)]"
              >
                <div className="text-sm font-semibold uppercase text-[#3b6c82]">
                  Step {index + 1}
                </div>
                <h3 className="mt-4 text-[1.25rem] font-black uppercase text-[#0b2450]">
                  {step.title}
                </h3>
      ...
      <section className="relative overflow-hidden bg-[#0b2450] py-20 text-white">
        ...
        <div className="content-container relative">
          ...
          <div className="mx-auto mt-12 max-w-[980px] border border-white/10 bg-white/6 p-8 backdrop-blur-sm">
          ...
          <div className="mx-auto mt-14 grid max-w-[1160px] gap-6 lg:grid-cols-2 xl:grid-cols-3">
            {testimonials.map((testimonial) => (
              ...
              >
                ...
                <p className="mt-6 text-sm font-semibold uppercase text-[#0b2450]">
                  {testimonial.author}
                </p>
              </article>
            ))}
