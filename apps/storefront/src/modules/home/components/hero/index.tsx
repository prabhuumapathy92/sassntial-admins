  ...
  return (
    <section className="relative overflow-hidden bg-[#072a36] text-white">
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute -left-24 top-20 h-72 w-72 bg-[#1d8199]/22 blur-3xl" />
        <div className="absolute right-0 top-28 h-96 w-96 bg-[#0d5d74]/24 blur-3xl" />
      </div>
      ...
      <div className="content-container relative px-6 pb-20 pt-14 sm:pb-24 sm:pt-20">
        <div className="mx-auto max-w-[1200px]">
          ...
          <h4 className="mx-auto mt-7 max-w-[1080px] text-center text-[clamp(2.75rem,6vw,0.9rem)] font-black uppercase text-white">
